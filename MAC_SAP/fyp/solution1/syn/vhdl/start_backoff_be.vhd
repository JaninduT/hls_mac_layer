...
architecture behav of start_backoff_be is 
    ...
    signal CW_be_loc_2_reg_24 : STD_LOGIC_VECTOR (9 downto 0);
    signal invoke_reason_read_read_fu_18_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln346_fu_56_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln347_fu_68_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_random_int_gen_fu_37_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal shl_ln347_fu_62_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    CW_be_loc_2_reg_24_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if (((icmp_ln346_fu_56_p2 = ap_const_lv1_0) and (invoke_reason_read_read_fu_18_p2 = ap_const_lv1_1))) then 
                    CW_be_loc_2_reg_24 <= or_ln347_fu_68_p2;
                elsif (((icmp_ln346_fu_56_p2 = ap_const_lv1_1) and (invoke_reason_read_read_fu_18_p2 = ap_const_lv1_1))) then 
    ...
    CW_be_o_assign_proc : process(ap_start, ap_CS_fsm_state1, CW_be_i, invoke_reason_read_read_fu_18_p2, icmp_ln346_fu_56_p2, or_ln347_fu_68_p2)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
            if (((icmp_ln346_fu_56_p2 = ap_const_lv1_0) and (invoke_reason_read_read_fu_18_p2 = ap_const_lv1_1))) then 
    ...
    CW_be_o_ap_vld_assign_proc : process(ap_start, ap_CS_fsm_state1, invoke_reason_read_read_fu_18_p2, icmp_ln346_fu_56_p2)
    begin
        if ((((ap_start = ap_const_logic_1) and (icmp_ln346_fu_56_p2 = ap_const_lv1_0) and (invoke_reason_read_read_fu_18_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_start = ap_const_logic_1) and (invoke_reason_read_read_fu_18_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    be_backoff_counter <= grp_random_int_gen_fu_37_ap_return;

    be_backoff_counter_ap_vld_assign_proc : process(grp_random_int_gen_fu_37_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_random_int_gen_fu_37_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    icmp_ln346_fu_56_p2 <= "1" when (CW_be_i = ap_const_lv10_3FF) else "0";
    invoke_reason_read_read_fu_18_p2 <= invoke_reason;
    or_ln347_fu_68_p2 <= (shl_ln347_fu_62_p2 or ap_const_lv10_1);
    ...
    rand_state_o_ap_vld <= grp_random_int_gen_fu_37_rand_state_o_ap_vld;
    shl_ln347_fu_62_p2 <= std_logic_vector(shift_left(unsigned(CW_be_i),to_integer(unsigned('0' & ap_const_lv10_1(10-1 downto 0)))));
end behav;
