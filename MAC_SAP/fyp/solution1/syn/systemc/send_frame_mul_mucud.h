...
// ==============================================================
#ifndef __send_frame_mul_mucud__HH__
#define __send_frame_mul_mucud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(send_frame_mul_mucud) {
    ...
    SC_CTOR(send_frame_mul_mucud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
