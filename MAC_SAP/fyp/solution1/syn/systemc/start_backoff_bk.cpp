...
const sc_logic start_backoff_bk::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic start_backoff_bk::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<2> start_backoff_bk::ap_ST_fsm_state1 = "1";
const sc_lv<2> start_backoff_bk::ap_ST_fsm_state2 = "10";
const sc_lv<32> start_backoff_bk::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<10> start_backoff_bk::ap_const_lv10_F = "1111";
const sc_lv<1> start_backoff_bk::ap_const_lv1_0 = "0";
const sc_lv<1> start_backoff_bk::ap_const_lv1_1 = "1";
const sc_lv<32> start_backoff_bk::ap_const_lv32_1 = "1";
const sc_lv<10> start_backoff_bk::ap_const_lv10_3FF = "1111111111";
const sc_lv<10> start_backoff_bk::ap_const_lv10_1 = "1";
const bool start_backoff_bk::ap_const_boolean_1 = true;

start_backoff_bk::start_backoff_bk(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    grp_random_int_gen_fu_37->max_val(CW_bk_loc_2_reg_24);
    ...
    sensitive << ( icmp_ln357_fu_56_p2 );
    sensitive << ( or_ln358_fu_68_p2 );
    ...
    SC_METHOD(thread_icmp_ln357_fu_56_p2);
    sensitive << ( ap_start );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( CW_bk_i );
    sensitive << ( invoke_reason_read_read_fu_18_p2 );
    ...
    SC_METHOD(thread_or_ln358_fu_68_p2);
    sensitive << ( shl_ln358_fu_62_p2 );
    ...
    SC_METHOD(thread_shl_ln358_fu_62_p2);
    sensitive << ( CW_bk_i );
    ...
    apTFilenSS << "start_backoff_bk_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, CW_bk_loc_2_reg_24, "CW_bk_loc_2_reg_24");
    sc_trace(mVcdFile, invoke_reason_read_read_fu_18_p2, "invoke_reason_read_read_fu_18_p2");
    sc_trace(mVcdFile, icmp_ln357_fu_56_p2, "icmp_ln357_fu_56_p2");
    sc_trace(mVcdFile, or_ln358_fu_68_p2, "or_ln358_fu_68_p2");
    sc_trace(mVcdFile, grp_random_int_gen_fu_37_ap_start_reg, "grp_random_int_gen_fu_37_ap_start_reg");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, shl_ln358_fu_62_p2, "shl_ln358_fu_62_p2");
...
start_backoff_bk::~start_backoff_bk() {
    if (mVcdFile) 
...
void start_backoff_bk::thread_ap_clk_no_reset_() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        if ((esl_seteq<1,1,1>(invoke_reason_read_read_fu_18_p2.read(), ap_const_lv1_1) && 
             esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln357_fu_56_p2.read()))) {
            CW_bk_loc_2_reg_24 = or_ln358_fu_68_p2.read();
        } else if ((esl_seteq<1,1,1>(invoke_reason_read_read_fu_18_p2.read(), ap_const_lv1_1) && 
                    esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln357_fu_56_p2.read()))) {
            CW_bk_loc_2_reg_24 = CW_bk_i.read();
        } else if (esl_seteq<1,1,1>(invoke_reason_read_read_fu_18_p2.read(), ap_const_lv1_0)) {
            CW_bk_loc_2_reg_24 = ap_const_lv10_F;
        }
    }
...
void start_backoff_bk::thread_CW_bk_o() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        if ((esl_seteq<1,1,1>(invoke_reason_read_read_fu_18_p2.read(), ap_const_lv1_1) && 
             esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln357_fu_56_p2.read()))) {
            CW_bk_o = or_ln358_fu_68_p2.read();
        } else if (esl_seteq<1,1,1>(invoke_reason_read_read_fu_18_p2.read(), ap_const_lv1_0)) {
            CW_bk_o = ap_const_lv10_F;
        } else {
...
void start_backoff_bk::thread_CW_bk_o_ap_vld() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
          esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
         ...
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
          ...
          esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln357_fu_56_p2.read())))) {
        CW_bk_o_ap_vld = ap_const_logic_1;
    } else {
        CW_bk_o_ap_vld = ap_const_logic_0;
    }
}

void start_backoff_bk::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void start_backoff_bk::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void start_backoff_bk::thread_ap_done() {
...
void start_backoff_bk::thread_ap_idle() {
    if ((esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void start_backoff_bk::thread_ap_ready() {
...
void start_backoff_bk::thread_bk_backoff_counter() {
    bk_backoff_counter = grp_random_int_gen_fu_37_ap_return.read();
}

void start_backoff_bk::thread_bk_backoff_counter_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         esl_seteq<1,1,1>(grp_random_int_gen_fu_37_ap_done.read(), ap_const_logic_1))) {
...
void start_backoff_bk::thread_grp_random_int_gen_fu_37_ap_start() {
    grp_random_int_gen_fu_37_ap_start = grp_random_int_gen_fu_37_ap_start_reg.read();
}

void start_backoff_bk::thread_icmp_ln357_fu_56_p2() {
    icmp_ln357_fu_56_p2 = (!CW_bk_i.read().is_01() || !ap_const_lv10_3FF.is_01())? sc_lv<1>(): sc_lv<1>(CW_bk_i.read() == ap_const_lv10_3FF);
}

void start_backoff_bk::thread_invoke_reason_read_read_fu_18_p2() {
    invoke_reason_read_read_fu_18_p2 = invoke_reason.read();
}

void start_backoff_bk::thread_or_ln358_fu_68_p2() {
    or_ln358_fu_68_p2 = (shl_ln358_fu_62_p2.read() | ap_const_lv10_1);
}

void start_backoff_bk::thread_rand_state_o() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
...
void start_backoff_bk::thread_rand_state_o_ap_vld() {
    rand_state_o_ap_vld = grp_random_int_gen_fu_37_rand_state_o_ap_vld.read();
}

void start_backoff_bk::thread_shl_ln358_fu_62_p2() {
    shl_ln358_fu_62_p2 = (!ap_const_lv10_1.is_01())? sc_lv<10>(): CW_bk_i.read() << (unsigned short)ap_const_lv10_1.to_uint();
}

void start_backoff_bk::thread_ap_NS_fsm() {
