...
// ==============================================================
#ifndef __backoff_vi_sitofpdEe__HH__
#define __backoff_vi_sitofpdEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(backoff_vi_sitofpdEe) {
    ...
    SC_CTOR(backoff_vi_sitofpdEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {
