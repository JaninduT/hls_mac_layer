...
#ifndef _start_backoff_vi_HH_
#define _start_backoff_vi_HH_
...
struct start_backoff_vi : public sc_module {
    ...
    // Module declarations
    start_backoff_vi(sc_module_name name);
    SC_HAS_PROCESS(start_backoff_vi);
    ...
    sc_signal< sc_lv<10> > CW_vi_loc_2_reg_24;
    sc_signal< sc_lv<1> > invoke_reason_read_read_fu_18_p2;
    sc_signal< sc_lv<1> > icmp_ln335_fu_56_p2;
    sc_signal< sc_lv<10> > or_ln336_fu_68_p2;
    sc_signal< sc_logic > grp_random_int_gen_fu_37_ap_start_reg;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<10> > shl_ln336_fu_62_p2;
