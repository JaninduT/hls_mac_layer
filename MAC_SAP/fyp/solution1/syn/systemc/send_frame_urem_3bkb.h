...
// ==============================================================
#ifndef __send_frame_urem_3bkb__HH__
#define __send_frame_urem_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(send_frame_urem_3bkb) {
    ...
    SC_CTOR(send_frame_urem_3bkb):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
