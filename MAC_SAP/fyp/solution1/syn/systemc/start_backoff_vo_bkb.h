...
// ==============================================================
#ifndef __start_backoff_vo_bkb__HH__
#define __start_backoff_vo_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(start_backoff_vo_bkb) {
    ...
    SC_CTOR(start_backoff_vo_bkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
