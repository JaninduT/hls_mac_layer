...
// ==============================================================
#ifndef __backoff_vi_mul_mueOg__HH__
#define __backoff_vi_mul_mueOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(backoff_vi_mul_mueOg) {
    ...
    SC_CTOR(backoff_vi_mul_mueOg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
