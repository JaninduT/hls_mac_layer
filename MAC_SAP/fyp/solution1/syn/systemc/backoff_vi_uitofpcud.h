...
// ==============================================================
#ifndef __backoff_vi_uitofpcud__HH__
#define __backoff_vi_uitofpcud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(backoff_vi_uitofpcud) {
    ...
    SC_CTOR(backoff_vi_uitofpcud):  ACMP_uitofp_U ("ACMP_uitofp_U") {
