...
#ifndef _start_backoff_bk_HH_
#define _start_backoff_bk_HH_
...
struct start_backoff_bk : public sc_module {
    ...
    // Module declarations
    start_backoff_bk(sc_module_name name);
    SC_HAS_PROCESS(start_backoff_bk);
    ...
    sc_signal< sc_lv<10> > CW_bk_loc_2_reg_24;
    sc_signal< sc_lv<1> > invoke_reason_read_read_fu_18_p2;
    sc_signal< sc_lv<1> > icmp_ln357_fu_56_p2;
    sc_signal< sc_lv<10> > or_ln358_fu_68_p2;
    sc_signal< sc_logic > grp_random_int_gen_fu_37_ap_start_reg;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<10> > shl_ln358_fu_62_p2;
