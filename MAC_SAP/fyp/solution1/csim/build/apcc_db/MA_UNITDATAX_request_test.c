...
void ma_unitdatax_request(l_struct_OC_mac48 , l_struct_OC_mac48 ,  char *,  char , bool , l_struct_OC_channel_identifier ,  char ,  char ,  char , signed long long , bool *);
...
printf("\n = 0x%X\n", ((unsigned char )-78));
if (AESL_DEBUG_TRACE)
printf("\n  store i7 0, i7* %%io_d_rate, align 1, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_37_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = add nsw i32 %%storemerge3, 1, !dbg !13 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @ma_unitdatax_request(%%struct.mac48* byval @aesl_internal_my_mac, %%struct.mac48* byval @aesl_internal_bcast_wcard_mac, i8* %%14, i4 zeroext 6, i1 zeroext true, %%struct.channel_identifier* byval %%ci, i2 zeroext 0, i7 zeroext 6, i4 zeroext 4, i64 100, i1* %%med_sts) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_70_count);
  ma_unitdatax_request(aesl_internal_my_mac, aesl_internal_bcast_wcard_mac, ( char *)llvm_cbe_tmp__9, ((unsigned char )6), 1, llvm_cbe_ci, ((unsigned char )0), ((unsigned char )6), ((unsigned char )4), 100ull, (bool *)(&llvm_cbe_med_sts));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @ma_unitdatax_request(%%struct.mac48* byval @aesl_internal_my_mac, %%struct.mac48* byval @aesl_internal_bcast_wcard_mac, i8* %%14, i4 zeroext 2, i1 zeroext true, %%struct.channel_identifier* byval %%ci, i2 zeroext 0, i7 zeroext 6, i4 zeroext 4, i64 100, i1* %%med_sts) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_74_count);
  ma_unitdatax_request(aesl_internal_my_mac, aesl_internal_bcast_wcard_mac, ( char *)llvm_cbe_tmp__9, ((unsigned char )2), 1, llvm_cbe_ci, ((unsigned char )0), ((unsigned char )6), ((unsigned char )4), 100ull, (bool *)(&llvm_cbe_med_sts));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = trunc i32 %%16 to i4, !dbg !13 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_77_count);
  llvm_cbe_tmp__12 = (unsigned char )((unsigned char )llvm_cbe_tmp__11&15U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = zext i4 %%17 to i32, !dbg !13 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_80_count);
  llvm_cbe_tmp__13 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__12&15U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
...
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = sext i32 %%storemerge12 to i64, !dbg !14 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_103_count);
  llvm_cbe_tmp__19 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = getelementptr inbounds [100 x i8]* %%frame, i64 0, i64 %%25, !dbg !14 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_104_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = load i8* %%26, align 1, !dbg !14 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_105_count);
  llvm_cbe_tmp__21 = (unsigned char )*llvm_cbe_tmp__20;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = zext i8 %%27 to i32, !dbg !14 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_106_count);
  llvm_cbe_tmp__22 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__21&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str4, i64 0, i64 0), i32 %%28) nounwind, !dbg !14 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_107_count);
