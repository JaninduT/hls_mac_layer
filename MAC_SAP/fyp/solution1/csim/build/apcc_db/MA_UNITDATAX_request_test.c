...
void ma_unitdatax_request(l_struct_OC_mac48 , l_struct_OC_mac48 ,  char *,  char , bool , l_struct_OC_channel_identifier ,  char ,  char ,  char , signed long long );
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @ma_unitdatax_request(%%struct.mac48* byval @aesl_internal_my_mac, %%struct.mac48* byval @aesl_internal_bcast_wcard_mac, i8* %%14, i4 zeroext 6, i1 zeroext true, %%struct.channel_identifier* byval %%ci, i2 zeroext 0, i7 zeroext 6, i4 zeroext 4, i64 100) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
  ma_unitdatax_request(aesl_internal_my_mac, aesl_internal_bcast_wcard_mac, ( char *)llvm_cbe_tmp__9, ((unsigned char )6), 1, llvm_cbe_ci, ((unsigned char )0), ((unsigned char )6), ((unsigned char )4), 100ull);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @ma_unitdatax_request(%%struct.mac48* byval @aesl_internal_my_mac, %%struct.mac48* byval @aesl_internal_bcast_wcard_mac, i8* %%14, i4 zeroext 2, i1 zeroext true, %%struct.channel_identifier* byval %%ci, i2 zeroext 0, i7 zeroext 6, i4 zeroext 4, i64 100) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_66_count);
  ma_unitdatax_request(aesl_internal_my_mac, aesl_internal_bcast_wcard_mac, ( char *)llvm_cbe_tmp__9, ((unsigned char )2), 1, llvm_cbe_ci, ((unsigned char )0), ((unsigned char )6), ((unsigned char )4), 100ull);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = getelementptr inbounds [100 x i8]* %%frame, i64 0, i64 0, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_67_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = call i32 bitcast (i32 (...)* @enqueue_dequeue_frame to i32 (i32, i32, i8*, i7*, i4*)*)(i32 1, i32 3, i8* %%15, i7* %%io_d_rate, i4* %%io_tx_pwr_lvl) nounwind, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_68_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = trunc i32 %%16 to i4, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_69_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = add nsw i32 %%storemerge12, 1, !dbg !13 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_100_count);
...
llvm_cbe_tmp__34:
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = load i7* %%io_d_rate, align 1, !dbg !13 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_112_count);
...
llvm_cbe_tmp__35:
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = load i4* %%io_tx_pwr_lvl, align 1, !dbg !13 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_121_count);
