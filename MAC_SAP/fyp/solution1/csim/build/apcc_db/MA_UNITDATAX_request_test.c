...
if (AESL_DEBUG_TRACE)
printf("\n  call void @ma_unitdatax_request(%%struct.mac48* @aesl_internal_my_mac, %%struct.mac48* @aesl_internal_bcast_wcard_mac, i8* %%14, i4 zeroext 6, i1 zeroext true, %%struct.channel_identifier* byval %%ci, i2* %%ts, i7* %%dr, i4* %%tx_p_l, i64* %%exp) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_81_count);
  ma_unitdatax_request((l_struct_OC_mac48 *)(&aesl_internal_my_mac), (l_struct_OC_mac48 *)(&aesl_internal_bcast_wcard_mac), ( char *)llvm_cbe_tmp__9, ((unsigned char )6), 1, llvm_cbe_ci, ( char *)(&llvm_cbe_ts), ( char *)(&llvm_cbe_dr), ( char *)(&llvm_cbe_tx_p_l), (signed long long *)(&llvm_cbe_exp));
if (AESL_DEBUG_TRACE) {
