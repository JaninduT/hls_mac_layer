...
void send_frame(l_struct_OC_mac48 , l_struct_OC_mac48 ,  char *,  char , bool , l_struct_OC_channel_identifier ,  char ,  char ,  char , signed long long ,  char *, bool *,  char *,  char *);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @send_frame(%%struct.mac48* byval @aesl_internal_my_mac, %%struct.mac48* byval @aesl_internal_bcast_wcard_mac, i8* %%14, i4 zeroext 6, i1 zeroext true, %%struct.channel_identifier* byval %%ci, i2 zeroext 0, i7 zeroext 6, i4 zeroext 4, i64 100, i8* %%15, i1* %%med_sts, i3* %%current_txop_holder, i8* %%15) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_60_count);
  send_frame(aesl_internal_my_mac, aesl_internal_bcast_wcard_mac, ( char *)llvm_cbe_tmp__9, ((unsigned char )6), 1, llvm_cbe_ci, ((unsigned char )0), ((unsigned char )6), ((unsigned char )4), 100ull, ( char *)llvm_cbe_tmp__10, (bool *)(&llvm_cbe_med_sts), ( char *)(&llvm_cbe_current_txop_holder), ( char *)llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE) {
