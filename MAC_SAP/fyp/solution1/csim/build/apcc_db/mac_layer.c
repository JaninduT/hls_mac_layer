...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = call zeroext i1 @enqueue_dequeue_frame(i1 zeroext false, i2 zeroext 0, i8* %%1) nounwind, !dbg !5 for 0x%I64xth hint within @send_frame  --> \n", ++aesl_llvm_cbe_16_count);
  llvm_cbe_tmp__2 = (bool )((enqueue_dequeue_frame(0, ((unsigned char )0), ( char *)llvm_cbe_tmp__1))&1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0);
...
llvm_cbe_tmp__4:
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = call zeroext i1 @enqueue_dequeue_frame(i1 zeroext true, i2 zeroext 0, i8* %%mac_frame) nounwind, !dbg !4 for 0x%I64xth hint within @send_frame  --> \n", ++aesl_llvm_cbe_20_count);
  ((enqueue_dequeue_frame(1, ((unsigned char )0), ( char *)llvm_cbe_mac_frame))&1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",1);
printf("\nArgument  = 0x%X",((unsigned char )0));
