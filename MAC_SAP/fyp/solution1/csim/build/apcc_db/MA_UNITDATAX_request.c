...
void start_backoff_bk( char );
void start_backoff_be( char );
void start_backoff_vi( char );
void start_backoff_vo( char );
...
llvm_cbe_tmp__47:
if (AESL_DEBUG_TRACE)
printf("\n  call void @start_backoff_bk(i2 zeroext -2) nounwind, !dbg !15 for 0x%I64xth hint within @ma_unitdatax_request  --> \n", ++aesl_llvm_cbe_122_count);
  start_backoff_bk(((unsigned char )2u));
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__53:
if (AESL_DEBUG_TRACE)
printf("\n  call void @start_backoff_be(i2 zeroext -2) nounwind, !dbg !16 for 0x%I64xth hint within @ma_unitdatax_request  --> \n", ++aesl_llvm_cbe_139_count);
  start_backoff_be(((unsigned char )2u));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )2u));
}
  goto llvm_cbe_tmp__52;
...
llvm_cbe_tmp__59:
if (AESL_DEBUG_TRACE)
printf("\n  call void @start_backoff_vi(i2 zeroext -2) nounwind, !dbg !17 for 0x%I64xth hint within @ma_unitdatax_request  --> \n", ++aesl_llvm_cbe_156_count);
  start_backoff_vi(((unsigned char )2u));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )2u));
}
  goto llvm_cbe_tmp__58;
...
llvm_cbe_tmp__64:
if (AESL_DEBUG_TRACE)
printf("\n  call void @start_backoff_vo(i2 zeroext -2) nounwind, !dbg !18 for 0x%I64xth hint within @ma_unitdatax_request  --> \n", ++aesl_llvm_cbe_173_count);
  start_backoff_vo(((unsigned char )2u));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )2u));
}
  goto llvm_cbe_tmp__63;
