...
module AESL_automem_inout_frame (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.enqueue_dequeue_frame.autotvin_inout_frame.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.enqueue_dequeue_frame.autotvout_inout_frame.dat"; 
//------------------------Local signal-------------------
