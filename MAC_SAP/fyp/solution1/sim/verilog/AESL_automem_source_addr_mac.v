...
module AESL_automem_source_addr_mac (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.ma_unitdatax_request.autotvin_source_addr_mac.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.ma_unitdatax_request.autotvout_source_addr_mac.dat"; 
//------------------------Local signal-------------------
