...
if {[file isfile start_backoff_vo.autotvin.dat]} {
	file delete -force start_backoff_vo.autotvin.dat
}

if {[file isfile start_backoff_vo.autotvout.dat]} {
	file delete -force start_backoff_vo.autotvout.dat
}
