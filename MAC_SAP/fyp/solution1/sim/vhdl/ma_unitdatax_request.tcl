...
set priority_group [add_wave_group priority(wire) -into $cinputgroup]
add_wave /apatb_ma_unitdatax_request_top/AESL_inst_ma_unitdatax_request/priority -into $priority_group -radix hex
...
add_wave /apatb_ma_unitdatax_request_top/LENGTH_priority -into $tb_portdepth_group -radix hex
...
set tb_priority_group [add_wave_group priority(wire) -into $tbcinputgroup]
add_wave /apatb_ma_unitdatax_request_top/priority -into $tb_priority_group -radix hex
