# 1 "E:/FYP/HLS/MAC_SAP/fyp/initial_edca_proc.c"
# 1 "E:/FYP/HLS/MAC_SAP/fyp/initial_edca_proc.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "E:/FYP/HLS/MAC_SAP/fyp/initial_edca_proc.c" 2
...
# 5 "E:/FYP/HLS/MAC_SAP/fyp/initial_edca_proc.h" 2
...
# 2 "E:/FYP/HLS/MAC_SAP/fyp/initial_edca_proc.c" 2

void initial_edca_process(volatile uint1 *medium_state, uint3 *current_txop_holder,
  unsigned char frame_to_transfer[100]){
 uint1 idle_waited = 0;
 slot_boundary_timing(4, &idle_waited, medium_state);
 while(idle_waited){
