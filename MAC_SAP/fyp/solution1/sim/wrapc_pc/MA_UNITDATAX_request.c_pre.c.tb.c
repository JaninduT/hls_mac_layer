...
// ==============================================================
# 1 "E:/FYP/HLS/MAC_SAP/fyp/MA_UNITDATAX_request.c"
# 1 "E:/FYP/HLS/MAC_SAP/fyp/MA_UNITDATAX_request.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "E:/FYP/HLS/MAC_SAP/fyp/MA_UNITDATAX_request.c" 2
...
# 3 "E:/FYP/HLS/MAC_SAP/fyp/MA_UNITDATAX_request.c" 2
...
void ma_unitdatax_request (mac48 source_addr, mac48 dest_addr,
 ...
 compose_mac_frame(source_addr, 1, 1, seq_number, up, llc_data, mac_data);
