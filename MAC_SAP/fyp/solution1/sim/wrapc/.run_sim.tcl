...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "start_backoff_vo.autotvin.dat"
	set constFileTvOut       "start_backoff_vo.autotvout.dat"
	set constFileHdlTvIn     "start_backoff_vo.autohdltvin.dat"
	set constFileHdlTvOut    "start_backoff_vo.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
