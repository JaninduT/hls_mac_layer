...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ma_unitdatax_request.autotvin.dat"
	set constFileTvOut       "ma_unitdatax_request.autotvout.dat"
	set constFileHdlTvIn     "ma_unitdatax_request.autohdltvin.dat"
	set constFileHdlTvOut    "ma_unitdatax_request.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
