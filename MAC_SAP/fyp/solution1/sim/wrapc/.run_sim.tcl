...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "phy_data_confirm.autotvin.dat"
	set constFileTvOut       "phy_data_confirm.autotvout.dat"
	set constFileHdlTvIn     "phy_data_confirm.autohdltvin.dat"
	set constFileHdlTvOut    "phy_data_confirm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
