...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "backoff_vi.autotvin.dat"
	set constFileTvOut       "backoff_vi.autotvout.dat"
	set constFileHdlTvIn     "backoff_vi.autohdltvin.dat"
	set constFileHdlTvOut    "backoff_vi.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
