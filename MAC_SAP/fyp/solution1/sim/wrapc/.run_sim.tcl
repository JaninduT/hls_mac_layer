...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "send_frame.autotvin.dat"
	set constFileTvOut       "send_frame.autotvout.dat"
	set constFileHdlTvIn     "send_frame.autohdltvin.dat"
	set constFileHdlTvOut    "send_frame.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
