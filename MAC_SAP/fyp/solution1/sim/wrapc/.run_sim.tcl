...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "enqueue_dequeue_frame.autotvin.dat"
	set constFileTvOut       "enqueue_dequeue_frame.autotvout.dat"
	set constFileHdlTvIn     "enqueue_dequeue_frame.autohdltvin.dat"
	set constFileHdlTvOut    "enqueue_dequeue_frame.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
