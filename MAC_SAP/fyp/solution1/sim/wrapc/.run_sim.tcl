...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "slot_boundary_timing.autotvin.dat"
	set constFileTvOut       "slot_boundary_timing.autotvout.dat"
	set constFileHdlTvIn     "slot_boundary_timing.autohdltvin.dat"
	set constFileHdlTvOut    "slot_boundary_timing.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
