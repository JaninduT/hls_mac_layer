...
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = call zeroext i1 @AESL_WRAP_enqueue_dequeue_frame(i1 zeroext false, i2 zeroext 0, i8* %%10) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__8 = (bool )((AESL_WRAP_enqueue_dequeue_frame(0, ((unsigned char )0), ( char *)llvm_cbe_tmp__7))&1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = call zeroext i1 @AESL_WRAP_enqueue_dequeue_frame(i1 zeroext false, i2 zeroext 0, i8* %%10) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__9 = (bool )((AESL_WRAP_enqueue_dequeue_frame(0, ((unsigned char )0), ( char *)llvm_cbe_tmp__7))&1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0);
printf("\nArgument  = 0x%X",((unsigned char )0));
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = call zeroext i1 @AESL_WRAP_enqueue_dequeue_frame(i1 zeroext false, i2 zeroext 0, i8* %%10) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_27_count);
  llvm_cbe_tmp__10 = (bool )((AESL_WRAP_enqueue_dequeue_frame(0, ((unsigned char )0), ( char *)llvm_cbe_tmp__7))&1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0);
printf("\nArgument  = 0x%X",((unsigned char )0));
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = call zeroext i1 @AESL_WRAP_enqueue_dequeue_frame(i1 zeroext false, i2 zeroext 0, i8* %%10) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_30_count);
  llvm_cbe_tmp__11 = (bool )((AESL_WRAP_enqueue_dequeue_frame(0, ((unsigned char )0), ( char *)llvm_cbe_tmp__7))&1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0);
printf("\nArgument  = 0x%X",((unsigned char )0));
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = call zeroext i1 @AESL_WRAP_enqueue_dequeue_frame(i1 zeroext true, i2 zeroext 0, i8* %%15) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__13 = (bool )((AESL_WRAP_enqueue_dequeue_frame(1, ((unsigned char )0), ( char *)llvm_cbe_tmp__12))&1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",1);
printf("\nArgument  = 0x%X",((unsigned char )0));
