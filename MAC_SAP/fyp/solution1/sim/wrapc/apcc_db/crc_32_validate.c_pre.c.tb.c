...
signed int validate_crc( char *llvm_cbe_data);
...
llvm_cbe_tmp__32:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge8 = phi i32 [ 0, %%0 ], [ %%65, %%64  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge8_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge237 = phi i32 [ -1, %%0 ], [ %%storemerge2.7, %%64  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge237_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i32 %%storemerge8 to i64, !dbg !2 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_14_count);
  llvm_cbe_tmp__1 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge8);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds i8* %%data, i64 %%2, !dbg !2 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_15_count);
  llvm_cbe_tmp__2 = ( char *)(&llvm_cbe_data[(((signed long long )llvm_cbe_tmp__1))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__1));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load i8* %%3, align 1, !dbg !2 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_16_count);
  llvm_cbe_tmp__3 = (unsigned char )*llvm_cbe_tmp__2;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = zext i8 %%4 to i32, !dbg !2 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_17_count);
  llvm_cbe_tmp__4 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__3&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = shl nuw i32 %%5, 24, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__5 = (unsigned int )llvm_cbe_tmp__4 << 24u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = xor i32 %%6, %%storemerge237, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_21_count);
...
llvm_cbe_tmp__35:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2.7 = phi i32 [ %%60, %%59 ], [ %%63, %%61  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge2_2e_7_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%65 = add nsw i32 %%storemerge8, 1, !dbg !4 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_168_count);
...
llvm_cbe_tmp__37:
if (AESL_DEBUG_TRACE)
printf("\n  %%60 = shl i32 %%storemerge2.6, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_153_count);
...
llvm_cbe_tmp__38:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2.6 = phi i32 [ %%53, %%52 ], [ %%56, %%54  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge2_2e_6_count);
...
llvm_cbe_tmp__40:
if (AESL_DEBUG_TRACE)
printf("\n  %%53 = shl i32 %%storemerge2.5, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_136_count);
...
llvm_cbe_tmp__41:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2.5 = phi i32 [ %%46, %%45 ], [ %%49, %%47  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge2_2e_5_count);
...
llvm_cbe_tmp__43:
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = shl i32 %%storemerge2.4, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_119_count);
...
llvm_cbe_tmp__44:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2.4 = phi i32 [ %%39, %%38 ], [ %%42, %%40  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge2_2e_4_count);
...
llvm_cbe_tmp__46:
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = shl i32 %%storemerge2.3, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_102_count);
...
llvm_cbe_tmp__47:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2.3 = phi i32 [ %%32, %%31 ], [ %%35, %%33  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge2_2e_3_count);
...
llvm_cbe_tmp__49:
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = shl i32 %%storemerge2.2, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_85_count);
...
llvm_cbe_tmp__50:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2.2 = phi i32 [ %%25, %%24 ], [ %%28, %%26  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge2_2e_2_count);
...
llvm_cbe_tmp__52:
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = shl i32 %%storemerge2.1, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_68_count);
...
llvm_cbe_tmp__53:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2.1 = phi i32 [ %%18, %%17 ], [ %%21, %%19  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge2_2e_1_count);
...
llvm_cbe_tmp__55:
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = shl i32 %%storemerge2, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_51_count);
...
llvm_cbe_tmp__56:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ %%13, %%12 ], [ %%11, %%9  for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
llvm_cbe_tmp__33:
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = shl i32 %%7, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_33_count);
  llvm_cbe_tmp__7 = (unsigned int )llvm_cbe_tmp__6 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = xor i32 %%10, 79764919, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_34_count);
...
llvm_cbe_tmp__34:
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = shl i32 %%7, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_37_count);
...
llvm_cbe_tmp__57:
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = shl i32 %%storemerge2, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_54_count);
  llvm_cbe_tmp__11 = (unsigned int )llvm_cbe_storemerge2 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = xor i32 %%20, 79764919, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_55_count);
...
llvm_cbe_tmp__54:
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = shl i32 %%storemerge2.1, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_71_count);
  llvm_cbe_tmp__14 = (unsigned int )llvm_cbe_storemerge2_2e_1 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = xor i32 %%27, 79764919, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_72_count);
...
llvm_cbe_tmp__51:
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = shl i32 %%storemerge2.2, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_88_count);
  llvm_cbe_tmp__17 = (unsigned int )llvm_cbe_storemerge2_2e_2 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = xor i32 %%34, 79764919, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_89_count);
...
llvm_cbe_tmp__48:
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = shl i32 %%storemerge2.3, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_105_count);
  llvm_cbe_tmp__20 = (unsigned int )llvm_cbe_storemerge2_2e_3 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = xor i32 %%41, 79764919, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_106_count);
...
llvm_cbe_tmp__45:
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = shl i32 %%storemerge2.4, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_122_count);
  llvm_cbe_tmp__23 = (unsigned int )llvm_cbe_storemerge2_2e_4 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = xor i32 %%48, 79764919, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_123_count);
...
llvm_cbe_tmp__42:
if (AESL_DEBUG_TRACE)
printf("\n  %%55 = shl i32 %%storemerge2.5, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_139_count);
  llvm_cbe_tmp__26 = (unsigned int )llvm_cbe_storemerge2_2e_5 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__26);
if (AESL_DEBUG_TRACE)
printf("\n  %%56 = xor i32 %%55, 79764919, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_140_count);
...
llvm_cbe_tmp__39:
if (AESL_DEBUG_TRACE)
printf("\n  %%62 = shl i32 %%storemerge2.6, 1, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_156_count);
  llvm_cbe_tmp__29 = (unsigned int )llvm_cbe_storemerge2_2e_6 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%63 = xor i32 %%62, 79764919, !dbg !3 for 0x%I64xth hint within @validate_crc  --> \n", ++aesl_llvm_cbe_157_count);
