...
void AESL_WRAP_phy_data_confirm( char *);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ %%7, %%.preheader ], [ 0, %%0  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = sext i32 %%storemerge2 to i64, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_9_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = add nsw i32 %%storemerge2, 1, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_12_count);
  llvm_cbe_tmp__5 = (unsigned int )((unsigned int )(llvm_cbe_storemerge2&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__5&4294967295ull)));
  if (((llvm_cbe_tmp__5&4294967295U) == (100u&4294967295U))) {
    goto llvm_cbe_tmp__10;
  } else {
    llvm_cbe_storemerge2__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__5;   /* for PHI node */
    goto llvm_cbe__2e_preheader;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_phy_data_confirm(i8* %%10) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_20_count);
  AESL_WRAP_phy_data_confirm(( char *)llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__9:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = phi i32 [ 1, %%3 ], [ 0, %%8  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge1_count);
