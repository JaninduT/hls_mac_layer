...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name backoff_vi_ap_sitofp_4_no_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Custom \
                          ...
                          CONFIG.component_name backoff_vi_ap_sitofp_4_no_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips backoff_vi_ap_sitofp_4_no_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files backoff_vi_ap_sitofp_4_no_dsp_32.xci]
generate_target {synthesis simulation} [get_files backoff_vi_ap_sitofp_4_no_dsp_32.xci]
