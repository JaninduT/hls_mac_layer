...
reg   [9:0] CW_bk_loc_2_reg_24;
wire   [0:0] invoke_reason_read_read_fu_18_p2;
wire   [0:0] icmp_ln357_fu_56_p2;
wire   [9:0] or_ln358_fu_68_p2;
reg    grp_random_int_gen_fu_37_ap_start_reg;
wire    ap_CS_fsm_state2;
wire   [9:0] shl_ln358_fu_62_p2;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if (((icmp_ln357_fu_56_p2 == 1'd0) & (invoke_reason_read_read_fu_18_p2 == 1'd1))) begin
            CW_bk_loc_2_reg_24 <= or_ln358_fu_68_p2;
        end else if (((icmp_ln357_fu_56_p2 == 1'd1) & (invoke_reason_read_read_fu_18_p2 == 1'd1))) begin
            CW_bk_loc_2_reg_24 <= CW_bk_i;
        end else if ((invoke_reason_read_read_fu_18_p2 == 1'd0)) begin
            CW_bk_loc_2_reg_24 <= 10'd15;
        end
    end
end
...
always @ (*) begin
    if ((((ap_start == 1'b1) & (icmp_ln357_fu_56_p2 == 1'd0) & (invoke_reason_read_read_fu_18_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1)) | ((ap_start == 1'b1) & (invoke_reason_read_read_fu_18_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1)))) begin
        CW_bk_o_ap_vld = 1'b1;
    end else begin
        CW_bk_o_ap_vld = 1'b0;
    end
...
assign bk_backoff_counter = grp_random_int_gen_fu_37_ap_return;

assign grp_random_int_gen_fu_37_ap_start = grp_random_int_gen_fu_37_ap_start_reg;

assign icmp_ln357_fu_56_p2 = ((CW_bk_i == 10'd1023) ? 1'b1 : 1'b0);

assign invoke_reason_read_read_fu_18_p2 = invoke_reason;

assign or_ln358_fu_68_p2 = (shl_ln358_fu_62_p2 | 10'd1);

assign rand_state_o_ap_vld = grp_random_int_gen_fu_37_rand_state_o_ap_vld;

assign shl_ln358_fu_62_p2 = CW_bk_i << 10'd1;

endmodule //start_backoff_bk
