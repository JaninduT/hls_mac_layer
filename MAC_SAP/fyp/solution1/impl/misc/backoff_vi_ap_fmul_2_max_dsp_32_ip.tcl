...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name backoff_vi_ap_fmul_2_max_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name backoff_vi_ap_fmul_2_max_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips backoff_vi_ap_fmul_2_max_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files backoff_vi_ap_fmul_2_max_dsp_32.xci]
generate_target {synthesis simulation} [get_files backoff_vi_ap_fmul_2_max_dsp_32.xci]
