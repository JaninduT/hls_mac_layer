...
`define AUTOTB_DUT      backoff_vi
`define AUTOTB_DUT_INST AESL_inst_backoff_vi
`define AUTOTB_TOP      apatb_backoff_vi_top
`define AUTOTB_LAT_RESULT_FILE "backoff_vi.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "backoff_vi.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_backoff_vi_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_current_txop_holder 1
`define AUTOTB_TVIN_current_txop_holder  "./c.backoff_vi.autotvin_current_txop_holder.dat"
`define AUTOTB_TVIN_current_txop_holder_out_wrapc  "./rtl.backoff_vi.autotvin_current_txop_holder.dat"
`define AUTOTB_TVOUT_current_txop_holder  "./c.backoff_vi.autotvout_current_txop_holder.dat"
`define AUTOTB_TVOUT_current_txop_holder_out_wrapc  "./impl_rtl.backoff_vi.autotvout_current_txop_holder.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.backoff_vi.autotvout_current_txop_holder.dat", "r");
    fp2 = $fopen("./impl_rtl.backoff_vi.autotvout_current_txop_holder.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.backoff_vi.autotvout_current_txop_holder.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.backoff_vi.autotvout_current_txop_holder.dat\"!");
    else begin
        $display("Comparing rtl.backoff_vi.autotvout_current_txop_holder.dat with impl_rtl.backoff_vi.autotvout_current_txop_holder.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
