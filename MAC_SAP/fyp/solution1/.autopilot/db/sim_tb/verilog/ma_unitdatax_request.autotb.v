...
`define AUTOTB_DUT      ma_unitdatax_request
`define AUTOTB_DUT_INST AESL_inst_ma_unitdatax_request
`define AUTOTB_TOP      apatb_ma_unitdatax_request_top
`define AUTOTB_LAT_RESULT_FILE "ma_unitdatax_request.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "ma_unitdatax_request.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_ma_unitdatax_request_top
...
`define AUTOTB_TVIN_c_identifier_operating_class  "./c.ma_unitdatax_request.autotvin_c_identifier_operating_class.dat"
`define AUTOTB_TVIN_c_identifier_channel_number  "./c.ma_unitdatax_request.autotvin_c_identifier_channel_number.dat"
`define AUTOTB_TVIN_d_rate  "./c.ma_unitdatax_request.autotvin_d_rate.dat"
`define AUTOTB_TVIN_tx_power_lvl  "./c.ma_unitdatax_request.autotvin_tx_power_lvl.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.ma_unitdatax_request.autotvin_data.dat"
`define AUTOTB_TVIN_up_out_wrapc  "./rtl.ma_unitdatax_request.autotvin_up.dat"
`define AUTOTB_TVIN_s_class_out_wrapc  "./rtl.ma_unitdatax_request.autotvin_s_class.dat"
`define AUTOTB_TVIN_c_identifier_operating_class_out_wrapc  "./rtl.ma_unitdatax_request.autotvin_c_identifier_operating_class.dat"
`define AUTOTB_TVIN_c_identifier_channel_number_out_wrapc  "./rtl.ma_unitdatax_request.autotvin_c_identifier_channel_number.dat"
`define AUTOTB_TVIN_d_rate_out_wrapc  "./rtl.ma_unitdatax_request.autotvin_d_rate.dat"
