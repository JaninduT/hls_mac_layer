...
`define AUTOTB_TVIN_source_addr_mac  "./c.send_frame.autotvin_source_addr_mac.dat"
`define AUTOTB_TVIN_data  "./c.send_frame.autotvin_data.dat"
`define AUTOTB_TVIN_up  "./c.send_frame.autotvin_up.dat"
`define AUTOTB_TVIN_s_class  "./c.send_frame.autotvin_s_class.dat"
`define AUTOTB_TVIN_c_identifier_operating_class  "./c.send_frame.autotvin_c_identifier_operating_class.dat"
`define AUTOTB_TVIN_c_identifier_channel_number  "./c.send_frame.autotvin_c_identifier_channel_number.dat"
`define AUTOTB_TVIN_d_rate  "./c.send_frame.autotvin_d_rate.dat"
`define AUTOTB_TVIN_tx_power_lvl  "./c.send_frame.autotvin_tx_power_lvl.dat"
`define AUTOTB_TVIN_mac_frame  "./c.send_frame.autotvin_mac_frame.dat"
`define AUTOTB_TVIN_medium_state  "./c.send_frame.autotvin_medium_state.dat"
`define AUTOTB_TVIN_current_txop_holder  "./c.send_frame.autotvin_current_txop_holder.dat"
`define AUTOTB_TVIN_source_addr_mac_out_wrapc  "./rtl.send_frame.autotvin_source_addr_mac.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.send_frame.autotvin_data.dat"
`define AUTOTB_TVIN_up_out_wrapc  "./rtl.send_frame.autotvin_up.dat"
`define AUTOTB_TVIN_s_class_out_wrapc  "./rtl.send_frame.autotvin_s_class.dat"
`define AUTOTB_TVIN_c_identifier_operating_class_out_wrapc  "./rtl.send_frame.autotvin_c_identifier_operating_class.dat"
`define AUTOTB_TVIN_c_identifier_channel_number_out_wrapc  "./rtl.send_frame.autotvin_c_identifier_channel_number.dat"
`define AUTOTB_TVIN_d_rate_out_wrapc  "./rtl.send_frame.autotvin_d_rate.dat"
`define AUTOTB_TVIN_tx_power_lvl_out_wrapc  "./rtl.send_frame.autotvin_tx_power_lvl.dat"
`define AUTOTB_TVIN_mac_frame_out_wrapc  "./rtl.send_frame.autotvin_mac_frame.dat"
`define AUTOTB_TVIN_medium_state_out_wrapc  "./rtl.send_frame.autotvin_medium_state.dat"
`define AUTOTB_TVIN_current_txop_holder_out_wrapc  "./rtl.send_frame.autotvin_current_txop_holder.dat"
`define AUTOTB_TVOUT_mac_frame  "./c.send_frame.autotvout_mac_frame.dat"
`define AUTOTB_TVOUT_current_txop_holder  "./c.send_frame.autotvout_current_txop_holder.dat"
`define AUTOTB_TVOUT_mac_frame_out_wrapc  "./impl_rtl.send_frame.autotvout_mac_frame.dat"
`define AUTOTB_TVOUT_current_txop_holder_out_wrapc  "./impl_rtl.send_frame.autotvout_current_txop_holder.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.send_frame.autotvout_mac_frame.dat", "r");
    fp2 = $fopen("./impl_rtl.send_frame.autotvout_mac_frame.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.send_frame.autotvout_mac_frame.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.send_frame.autotvout_mac_frame.dat\"!");
    else begin
        $display("Comparing rtl.send_frame.autotvout_mac_frame.dat with impl_rtl.send_frame.autotvout_mac_frame.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.send_frame.autotvout_current_txop_holder.dat", "r");
    fp2 = $fopen("./impl_rtl.send_frame.autotvout_current_txop_holder.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.send_frame.autotvout_current_txop_holder.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.send_frame.autotvout_current_txop_holder.dat\"!");
    else begin
        $display("Comparing rtl.send_frame.autotvout_current_txop_holder.dat with impl_rtl.send_frame.autotvout_current_txop_holder.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
