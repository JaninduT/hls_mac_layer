# 1 "fyp/compose_mac_frame.c"
# 1 "fyp/compose_mac_frame.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
void compose_mac_header(frame_type_t ftype, frame_subtype_t fstype,
  ...
  unsigned char frame_buffer[100]){_ssdm_SpecArrayDimSize(frame_buffer, 100);
...
void compose_mac_frame(frame_type_t ftype, frame_subtype_t fstype,
  sequence_number_t seqnumber, user_priority_t up,
  unsigned char data[70], unsigned char mac_frame[100]){_ssdm_SpecArrayDimSize(data, 70);_ssdm_SpecArrayDimSize(mac_frame, 100);
