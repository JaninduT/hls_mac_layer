# 1 "fyp/crc_32_validate.c"
# 1 "fyp/crc_32_validate.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "fyp/crc_32_validate.c" 2



unsigned int validate_crc(unsigned char data[100]){_ssdm_SpecArrayDimSize(data, 100);
