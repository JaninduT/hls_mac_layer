# 1 "fyp/decompose_mac_frame.c"
# 1 "fyp/decompose_mac_frame.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "fyp/decompose_mac_frame.c" 2

uint1 decompose_mac_frame(unsigned char mac_frame[100], unsigned char data[70],
  mac48 *source_mac, mac48 *dest_mac, user_priority_t *up){_ssdm_SpecArrayDimSize(mac_frame, 100);_ssdm_SpecArrayDimSize(data, 70);
