...
# 3 "fyp/PHY_RXEND_indication.c" 2
# 1 "fyp/crc_32.h" 1
...
# 4 "fyp/PHY_RXEND_indication.c" 2
# 1 "fyp/MA_UNITDATA_indication.h" 1
...
# 5 "fyp/PHY_RXEND_indication.c" 2
# 1 "fyp/decompose_mac_frame.h" 1
...
# 6 "fyp/PHY_RXEND_indication.c" 2
...
void phy_rxend_indication(enum rx_error rec_error, volatile uint1 *medium_state,
  ...
  unsigned char received_frame[100]){_ssdm_SpecArrayDimSize(frame_to_transfer, 100);_ssdm_SpecArrayDimSize(received_frame, 100);
 uint1 idle_waited = 0;
