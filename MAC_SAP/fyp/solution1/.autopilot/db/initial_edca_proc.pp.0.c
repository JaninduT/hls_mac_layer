# 1 "fyp/initial_edca_proc.c"
# 1 "fyp/initial_edca_proc.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "fyp/initial_edca_proc.c" 2
# 1 "fyp/initial_edca_proc.h" 1
...
# 2 "fyp/initial_edca_proc.c" 2

void initial_edca_process(volatile uint1 *medium_state, uint3 *current_txop_holder,
  unsigned char frame_to_transfer[100]){_ssdm_SpecArrayDimSize(frame_to_transfer, 100);
 uint1 idle_waited = 0;
