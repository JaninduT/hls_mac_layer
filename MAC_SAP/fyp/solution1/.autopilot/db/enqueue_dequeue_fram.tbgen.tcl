...
set C_modelArgList {
	{ ac uint 2 regular  }
	{ inout_frame int 8 regular {array 100 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ac", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "inout_frame", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ac sc_in sc_lv 2 signal 0 } 
	{ inout_frame_address0 sc_out sc_lv 7 signal 1 } 
	{ inout_frame_ce0 sc_out sc_logic 1 signal 1 } 
	{ inout_frame_q0 sc_in sc_lv 8 signal 1 } 
...
set Spec2ImplPortList { 
	...
	inout_frame { ap_memory {  { inout_frame_address0 mem_address 1 7 }  { inout_frame_ce0 mem_ce 1 1 }  { inout_frame_q0 mem_dout 0 8 } } }
}
