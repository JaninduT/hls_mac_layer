set moduleName ma_unitdatax_status_s
set isTopModule 0
...
set C_modelName {ma_unitdatax_status_}
set C_modelType { void 0 }
set C_modelArgList {
	{ trans_sts uint 3 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "trans_sts", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ trans_sts sc_in sc_lv 3 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trans_sts", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "trans_sts", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	trans_sts { ap_none {  { trans_sts in_data 0 3 } } }
}
