# 1 "fyp/PHY_DATA_indication.c"
# 1 "fyp/PHY_DATA_indication.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "fyp/PHY_DATA_indication.c" 2
# 1 "fyp/PHY_DATA_indication.h" 1
...
# 2 "fyp/PHY_DATA_indication.c" 2

void phy_data_indication(unsigned char data, unsigned char received_frame[100],
  uint7 *rec_count){_ssdm_SpecArrayDimSize(received_frame, 100);
 if(*rec_count<100){
