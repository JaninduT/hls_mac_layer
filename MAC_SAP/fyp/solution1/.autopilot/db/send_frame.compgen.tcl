...
set ID 147
set hasByteEnable 0
set MemName send_frame_edca_qfYi
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mac_frame \
    op interface \
    ports { mac_frame_address0 { O 7 vector } mac_frame_ce0 { O 1 bit } mac_frame_we0 { O 1 bit } mac_frame_d0 { O 8 vector } mac_frame_q0 { I 8 vector } } \
} "
} else {
