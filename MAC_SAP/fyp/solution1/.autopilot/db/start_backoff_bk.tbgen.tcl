set moduleName start_backoff_bk
set isTopModule 0
...
set C_modelName {start_backoff_bk}
...
set portList { 
	...
	{ CW_bk_i sc_in sc_lv 10 signal 1 } 
	{ CW_bk_o sc_out sc_lv 10 signal 1 } 
	{ CW_bk_o_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ rand_state_i sc_in sc_lv 32 signal 2 } 
	{ rand_state_o sc_out sc_lv 32 signal 2 } 
	{ rand_state_o_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ bk_backoff_counter sc_out sc_lv 10 signal 3 } 
	{ bk_backoff_counter_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
