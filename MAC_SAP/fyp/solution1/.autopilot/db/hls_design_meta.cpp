...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("inout_frame_we0", 1, hls_out, 2, "ap_memory", "mem_we", 1),
	Port_Property("inout_frame_d0", 8, hls_out, 2, "ap_memory", "mem_din", 1),
	Port_Property("inout_frame_q0", 8, hls_in, 2, "ap_memory", "mem_dout", 1),
	Port_Property("ap_return", 1, hls_out, -1, "", "", 1),
};
const char* HLS_Design_Meta::dut_name = "enqueue_dequeue_frame";
