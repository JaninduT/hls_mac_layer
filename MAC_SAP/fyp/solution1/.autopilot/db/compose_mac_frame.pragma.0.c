...
void compose_mac_header(mac48 source_addr, frame_type_t ftype,
  ...
  user_priority_t up, unsigned char frame_buffer[100]){_ssdm_SpecArrayDimSize(frame_buffer, 100);
...
void compose_mac_frame(mac48 source_addr, frame_type_t ftype,
  ...
  unsigned char mac_frame[100]){_ssdm_SpecArrayDimSize(data, 70);_ssdm_SpecArrayDimSize(mac_frame, 100);
