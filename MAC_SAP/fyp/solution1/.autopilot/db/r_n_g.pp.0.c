...
{ _ssdm_RegionBegin("?Mul_low_Region_fyp/r_n_g.c:10:2");
# 10 "fyp/r_n_g.c"
low = low * A;
_ssdm_op_SpecResource(low, "?Mul_low_Region_fyp/r_n_g.c:10:2", "", "Mul", "", -1, "", "", "", "", "");
_ssdm_RegionEnd("?Mul_low_Region_fyp/r_n_g.c:10:2"); }
# 10 "fyp/r_n_g.c"
