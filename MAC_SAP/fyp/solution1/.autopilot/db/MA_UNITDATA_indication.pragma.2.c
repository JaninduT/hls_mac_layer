# 1 "fyp/MA_UNITDATA_indication.c"
# 1 "fyp/MA_UNITDATA_indication.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "fyp/MA_UNITDATA_indication.c" 2
...
# 5 "fyp/MA_UNITDATA_indication.h" 2
...
# 2 "fyp/MA_UNITDATA_indication.c" 2
...
void ma_unitdata_indication (volatile mac48 *source_addr, volatile mac48 *dest_addr,
  volatile unsigned char data[70], volatile user_priority_t *us_priority){_ssdm_SpecArrayDimSize(data, 70);
