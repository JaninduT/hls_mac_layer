...
set portList { 
	...
	{ current_txop_holder_i sc_in sc_lv 3 signal 0 } 
	{ current_txop_holder_o sc_out sc_lv 3 signal 0 } 
	{ current_txop_holder_o_ap_vld sc_out sc_logic 1 outvld 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.backoff_vi_fmul_3bkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.backoff_vi_uitofpcud_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.backoff_vi_sitofpdEe_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.backoff_vi_mul_mueOg_U4", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	backoff_vi {
		current_txop_holder {Type IO LastRead 0 FirstWrite 0}
