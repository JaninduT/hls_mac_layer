...
void send_frame(mac48 source_addr, mac48 dest_addr, unsigned char data[70],
  ...
  uint3 *current_txop_holder, unsigned char received_frame[100]){_ssdm_SpecArrayDimSize(data, 70);_ssdm_SpecArrayDimSize(mac_frame, 100);_ssdm_SpecArrayDimSize(received_frame, 100);
