# 1 "fyp/PHY_RXSTART_indication.c"
# 1 "fyp/PHY_RXSTART_indication.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "fyp/PHY_RXSTART_indication.c" 2
# 1 "fyp/PHY_RXSTART_indication.h" 1
...
# 5 "fyp/PHY_RXSTART_indication.h" 2
...
void phy_rxstart_indication(
  rx_vector rx_vec,
  uint7 *rec_count);
# 2 "fyp/PHY_RXSTART_indication.c" 2
