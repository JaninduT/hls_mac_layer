...
//}
//
//bool enqueue_frame(uint2 ac, unsigned char input_frame[100]){
//	if (ac == 0){
//		if(available_spaces_bk == 0){
//			return false;
//		}
//		for (int bk=0; bk<100; bk++){
//			 edca_fifo_bk[(write_pointer_bk*100)+bk] = input_frame[bk];
//		}
...
//			 edca_fifo_be[(write_pointer_be*100)+be] = input_frame[be];
//		}
...
//			 edca_fifo_vi[(write_pointer_vi*100)+vi] = input_frame[vi];
//		}
...
//			return false;
//		}
//		for (int vo=0; vo<100; vo++){
//			 edca_fifo_vo[(write_pointer_vo*100)+vo] = input_frame[vo];
//		}
...
//}
//
//bool dequeue_frame(uint2 ac, unsigned char output_frame[100]){
//	if (ac == 0){
//		if(available_spaces_bk == 4){
//			return false;
//		}
//		for (int bk=0; bk<100; bk++){
//			 output_frame[bk] = edca_fifo_bk[(read_pointer_bk*100)+bk];
//		}
...
//		}
//		for (int be=0; be<100; be++){
//			 output_frame[be] = edca_fifo_be[(read_pointer_be*100)+be];
//		}
...
//		}
//		for (int vi=0; vi<100; vi++){
//			 output_frame[vi] = edca_fifo_vi[(read_pointer_vi*100)+vi];
//		}
...
//		}
//		for (int vo=0; vo<100; vo++){
//			 output_frame[vo] = edca_fifo_vo[(read_pointer_vo*100)+vo];
//		}
...
bool enqueue_dequeue_frame(uint1 operation, uint2 ac, unsigned char inout_frame[100]){
